    ...
    if not ctx.message.author.bot:
        ...
        if voice_client == None:
            ...
            try:
                ...
                print(Exception)
                await client.say("Oops! Something went wrong. Please try m!leave and try again. :x:")
            ...
            try:
             ...
             await client.say("It seems like I currently playing something! Please try m!leave and try again. :x:")
    else:
        return False
